...
> {
  ...
  protected agent: RunnableSequence<{ steps: MCPGraphState['steps'] }, AgentFinish | AgentAction[]>
  ...
  constructor({
    ...
    agent: RunnableSequence<{ steps: MCPGraphState['steps'] }, AgentFinish | AgentAction[]>
  ...
  retrievalCondition(state: MCPGraphState) {
  ...
  agentCondition(state: MCPGraphState) {
  ...
  preparingNode = async (state: MCPGraphState, config?: ExecuteFuncConfig<MCPGraphState>) => {
    try {
  ...
  toolNode = async (state: MCPGraphState, config?: ExecuteFuncConfig<MCPGraphState>) => {
    let { actions } = state
    if (!actions) {
  ...
  agentNode = async (state: MCPGraphState, config?: ExecuteFuncConfig<MCPGraphState>) => {
    const invokeState = {
      ...state,
    }
    if (state.response) {
  ...
  responseNode(state: MCPGraphState, config?: ExecuteFuncConfig<MCPGraphState>) {
